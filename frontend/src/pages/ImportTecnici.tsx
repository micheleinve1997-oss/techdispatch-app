...
export default function ImportTecnici() {
  ...
  const downloadTemplate = () => {
    window.open(`${baseURL}/tecnici/template-tecnici`, '_blank')
  }
  ...
  const handleFile = async (f: File) => {
    ...
    try {
      ...
      form.append('file', f)
      const { data } = await api.post<PreviewData>('/tecnici/preview-import-tecnici', form, {
        timeout: 30000,
      })
      setPreview(data)
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      const { data } = await api.post<ImportResult>('/tecnici/import-tecnici', form, {
        timeout: 60000,
      })
      setResult(data)
      setStep('done')
    ...
    <div className="flex flex-col h-full">
      <div className="px-8 py-5 border-b border-slate-200 bg-white flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-base font-semibold text-slate-900">Importa tecnici</h1>
        </div>
      </div>
            ...
            <div className="space-y-5">
              ...
              >
                {loading
                  ...
                  : <><Upload size={15} /> Importa {preview.total_rows} tecnici</>
                }
              </button>
            </div>
          )}
