      ...
      <div className="px-8 py-6 border-b border-slate-200 bg-white">
        ...
        <div className="mt-4 relative">
          ...
          <input
            ...
            className="w-full max-w-sm pl-9 pr-4 py-2 text-sm border border-slate-200 rounded-lg bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 transition"
          />
        </div>
      </div>
